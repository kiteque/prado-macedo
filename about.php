...
<section id="main-container" class="main-container">
  <div class="container">
    <div class="row">
        <div class="col-lg-6">
          <h3 class="column-title">Prado Macedo</h3>
          <p>Empresa especializada em soluções de tecnologia da informação (IT), oferecendo serviços de desenvolvimento de software, suporte técnico.</p>
          <blockquote><p>Construimos o futuro com a inovação tecnologica.</p></blockquote>
          <p> Nosso objetivo é impulsionar a transformação digital de negócios de diversos setores, entregando soluções inovadoras, personalizadas e de alta qualidade. Com uma equipe qualificada e foco em excelência, ajudamos nossos clientes a otimizar processos, aumentar a eficiência e garantir a competitividade no mercado.</p>
          ...
          <div id="page-slider" class="page-slider small-bg">
                ...
                <div class="container">
                    <div class="box-slider-content">
                      <div class="box-slider-text">
                          <h2 class="box-slide-title">Liderança</h2>
                      </div>    
                    </div>
                </div>
              </div><!-- Item 1 end -->
              ...
              <div class="item" style="background-image:url(images/slider-pages/slide-page2.jpg)">
                <div class="container">
                    <div class="box-slider-content">
                      <div class="box-slider-text">
                          <h2 class="box-slide-title">Relacionamentos</h2>
                      </div>    
                    </div>
                </div>
              </div><!-- Item 1 end -->
              ...
              <div class="item" style="background-image:url(images/slider-pages/slide-page3.jpg)">
                <div class="container">
                    <div class="box-slider-content">
                      <div class="box-slider-text">
                          <h2 class="box-slide-title">Desempenho</h2>
                      </div>    
                    </div>
                </div>
              </div><!-- Item 1 end -->
        ...
        <div class="row">
          <div class="col-md-3 col-sm-6 ts-facts">
              ...
              <div class="ts-facts-content">
                <h2 class="ts-facts-num"><span class="counterUp" data-count="17">17</span></h2>
                <h3 class="ts-facts-title">Total Projetos</h3>
              </div>
          </div><!-- Col end -->
          ...
          <div class="col-md-3 col-sm-6 ts-facts mt-5 mt-sm-0">
              ...
              <div class="ts-facts-content">
                ...
                <h3 class="ts-facts-title">Membros da equipe</h3>
              </div>
          </div><!-- Col end -->
          ...
          <div class="col-md-3 col-sm-6 ts-facts mt-5 mt-md-0">
              ...
              <div class="ts-facts-content">
                <h2 class="ts-facts-num"><span class="counterUp" data-count="4000">4000</span></h2>
                <h3 class="ts-facts-title">Horas de trabalho</h3>
              </div>
          </div><!-- Col end -->
          ...
          <div class="col-md-3 col-sm-6 ts-facts mt-5 mt-md-0">
              ...
              <div class="ts-facts-content">
                <h2 class="ts-facts-num"><span class="counterUp" data-count="1">1</span></h2>
                <h3 class="ts-facts-title">Experiência</h3>
              </div>
          </div><!-- Col end -->
...
<section id="ts-team" class="ts-team">
  <div class="container">
    <div class="row text-center">
        <div class="col-lg-12">
          <h2 class="section-title">Serviço de qualidade</h2>
          <h3 class="section-sub-title">Equipe Profissional</h3>
        </div>
    </div><!--/ Title row end -->
